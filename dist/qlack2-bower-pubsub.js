...
(function(window) {
	 ...
	 * 'ping' is considered the default server QPubSub instance. If multiple
	 ...
	 * @param server A boolean, indicating whether this instance is a sevrer 
	 * instance or not.
	 */
	function init(iID, server) {
	 ...
	 * @param bool A boolean indicating whether loggin is active or not.
	 */
